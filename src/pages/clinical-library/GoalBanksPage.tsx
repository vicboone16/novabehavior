...
import { Target, Loader2, ExternalLink, Search, Library } from 'lucide-react';
import { Card, CardContent } from '@/components/ui/card';
import { Badge } from '@/components/ui/badge';
import { Input } from '@/components/ui/input';
import { Tabs, TabsList, TabsTrigger, TabsContent } from '@/components/ui/tabs';
import { useGoalBankDomains, useGoalSearch } from '@/hooks/useClinicalGoals';
import { LibraryProgramSearch } from '@/components/clinical-library/LibraryProgramSearch';
      ...
      <Tabs defaultValue="programs">
        <TabsList>
          <TabsTrigger value="programs" className="gap-1.5">
            <Library className="w-3.5 h-3.5" /> Program Library
          </TabsTrigger>
          <TabsTrigger value="goals" className="gap-1.5">
            <Target className="w-3.5 h-3.5" /> Goal Banks
          </TabsTrigger>
        </TabsList>

        <TabsContent value="programs" className="mt-4">
          <div className="mb-3">
            <h2 className="text-base font-semibold">Program Library</h2>
            <p className="text-xs text-muted-foreground">
              Browse, search, and filter all 172 canonical ABA programs
            </p>
          </div>
        ...
        <TabsContent value="goals" className="mt-4">
          ...
          {crosswalkTagFilter && (
            <Badge variant="secondary" className="text-xs cursor-pointer mb-3" onClick={() => navigate('/clinical-library/clinical-collections/goal-banks')}>
