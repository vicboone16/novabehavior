...
import { Plus, Edit2, Archive, ArchiveRestore, Search, BookOpen, ExternalLink } from 'lucide-react';
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center gap-2 mb-2">
        ...
        <h2 className="text-base font-semibold">Curriculum Systems</h2>
        <p className="text-xs text-muted-foreground ml-2">Formal, standardized curriculum frameworks</p>
      </div>
      ...
      {loading ? (
        ...
        <Card><CardContent className="py-8 text-center text-muted-foreground">No curriculum systems found</CardContent></Card>
      ) : (
